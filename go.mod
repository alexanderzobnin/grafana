...
require (
	...
	cuelang.org/go v0.11.0 // @grafana/grafana-as-code
	...
	github.com/grafana/grafana-app-sdk v0.42.0 // @grafana/grafana-app-platform-squad
	...
	github.com/stretchr/testify v1.11.0 // @grafana/grafana-backend-group
...
require (
	...
	github.com/grafana/grafana-app-sdk/logging v0.41.1 // indirect
