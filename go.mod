...
require (
	buf.build/gen/go/parca-dev/parca/connectrpc/go v1.18.0-20250106133455-d226cc6e7498.1 // @grafana/observability-traces-and-profiling
	buf.build/gen/go/parca-dev/parca/protocolbuffers/go v1.36.2-20250106133455-d226cc6e7498.1 // @grafana/observability-traces-and-profiling
	...
	connectrpc.com/connect v1.18.0 // @grafana/observability-traces-and-profiling
	...
	google.golang.org/protobuf v1.36.2 // @grafana/plugins-platform-backend
