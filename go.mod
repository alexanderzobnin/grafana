...
require (
	...
	buf.build/gen/go/parca-dev/parca/protocolbuffers/go v1.36.0-20241210134125-ae5a61330ad4.1 // @grafana/observability-traces-and-profiling
	...
	google.golang.org/protobuf v1.36.0 // @grafana/plugins-platform-backend
