...
require (
	...
	github.com/googleapis/gax-go/v2 v2.21.0 // indirect; @grafana/grafana-backend-group
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.67.0 // indirect; @grafana/plugins-platform-backend
	...
	google.golang.org/api v0.275.0 // @grafana/grafana-backend-group
...
require (
	...
	google.golang.org/genproto v0.0.0-20260319201613-d00831a3d3e7 // indirect; @grafana/grafana-backend-group
