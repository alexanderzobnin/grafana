...
require (
	...
	github.com/docker/docker v28.0.4+incompatible // @grafana/grafana-developer-enablement-squad
	...
	golang.org/x/net v0.38.0 // indirect; @grafana/oss-big-tent @grafana/partner-datasources
